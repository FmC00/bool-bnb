    ...
    <div class="container-fluid">
      <div id="row-dashboard" class="row p-md-5 p-1 bg-secondary">
        ...
        <div id="dashboard-right" class="col-12 col-md-9 bg-light d-flex flex-column justify-content-start justify-content-md-start vh-100">
          <div class="mr-0 mr-md-4 ml-0 ml-md-5">
            <div class="d-flex justify-content-between flex-wrap">
              ...
              <div class="w-100 d-md-none mb-3">
                <div class="w-100 d-flex flex-column align-items-start">
                  <h5>{{ Auth::user()->name }} {{ Auth::user()->surname }}</h5>
                  <a class="text-secondary" href="{{ route('addApartment') }}">Aggiungi appartamento</a>
                  <a class="text-secondary" href="{{ route('messagesApartment') }}">Bacheca messaggi</a>
                  <a class="text-secondary" href="{{ route('myDashboard') }}">I miei appartamenti</a>
                  <a class="text-secondary" href="{{ route('home') }}">Ritorna alla Homepage</a>
              ...
              <form class="search-form" action="" method="post">
                <div class="search-container mt-4 d-none d-md-inline-block">
                  @yield('right-options')
