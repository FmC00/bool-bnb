      ...
      <div id="filter-apartments-container" class="col-12 d-flex justify-content-center">
        <div id="filter-apartments-box" class="w-75 rounded mb-4 bg-white">
          ...
          <div class="w-100 text-center">
            <p>Cerca appartamenti a {{$location}} con:</p>
          </div>
          <form class="w-100 d-flex flex-wrap justify-content-center align-items-center" action="#" method="get">
            <div class="form-group">
              @foreach ($services as $service)
                <label class="btn btn-bnb m-1" for="title">{{$service -> name}}
                <input class="" type="checkbox" name="" value="">
                </label>
              @endforeach
              {{-- <label class="btn btn-bnb m-1" for="title">Piscina
              <input class="" type="checkbox" name="" value="">
              </label>
              <label class="btn btn-bnb m-1" for="title">Piscina
              <input class="" type="checkbox" name="" value="">
